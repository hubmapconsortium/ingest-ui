  ...
  render() {
    return (
      <Dialog aria-labelledby="group-dialog" open={this.props.show}>
              ...
              <div className="card text-center">
                <div className="card-body">
                  <h5 className="card-title">
                    You currently have multiple group assignments, Please select
                    a primary group for submission
                  </h5>
        ...
        <DialogActions>
          <Button className="btn btn-primary mr-1" onClick={this.props.submit}>
            Submit
          </Button>
