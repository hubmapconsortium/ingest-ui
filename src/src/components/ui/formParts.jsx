...
export function NewBadge(type, mini, status = 'NEW'){
  ...
  return (
    <Chip style={NewBadgeStyle} className={ "newBadge " + badgeClass(status)} icon={mini ? null : IconSelection(type,"new")} label={status} size="small" />
  )
}
